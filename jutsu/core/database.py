...
from jutsu import logging, Config, logbot
...
if "Sedex" in _RUN(_MGCLIENT.list_database_names()):
    _LOG.info(_LOG_STR, "SEDEX Database Found :) => Now Logging to it...")
else:
    _LOG.info(_LOG_STR, "SEDEX Database Not Found :( => Creating New Database...")

_DATABASE: AgnosticDatabase = _MGCLIENT["Sedex"]
